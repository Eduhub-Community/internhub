...
<b>This repo is for an intenship web app project organized by the Eduhub community Unilag, companies signup and login then post intenship opportunities. So student can signup and login to apply for the **intenships**.

To contribute as a frontend go to the wwwroot folder where the static files(css,javascript,bootstrapp) are located and start developing also where we have or Views folder that contains our Html files(razor pages supportted) and start building. 
...
**1.** Fork [this](https://github.com/Eduhub-Community/internhub) repository.

**2.** Clone your forked copy of the project.

```
git clone https://github.com/<your-github-username>/internhub.git
```

**3.** Add a reference(remote) to the original repository.

```
git remote add upstream https://github.com/Eduhub-Community/internhub.git
```
